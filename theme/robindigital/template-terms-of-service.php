...
<main class="pt-32 pb-16 bg-robin-cream min-h-screen">
    <div class="container mx-auto px-4 md:px-6">
        <article class="bg-white rounded-xl p-6 md:p-8 shadow-lg border-2 border-robin-orange/10 max-w-4xl mx-auto">
            <header class="entry-header mb-8 text-center">
                <h1 class="text-3xl md:text-4xl font-bold mb-4 text-robin-dark">Terms of Service</h1>
                <p class="text-robin-dark/70">Last updated: <?php echo date('F j, Y'); ?></p>
            </header>
